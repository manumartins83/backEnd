...
class Produit
{
    ...
    public function getProductsByName($name)
    {
        ...
        return $this->dao->select('t_d_produit', 'Nom_court like :search or Nom_Long like :search2', $params, 'Nom_court');
    }
    ...
    public function insertProduit($tauxtva, $nomlong, $nomcourt, $reffr, $photo, $prix, $idfournisseur, $idcat)
    {
    ...
    {
        $sql = "UPDATE t_d_produit SET Nom_court = :nom, Ref_fournisseur = :reference, Prix_Achat = :prix, Photo = :photo WHERE Id_Produit = :id";
        $params = array(
            ':id' => $id,
            ':nom' => $nom,
            ':reference' => $reference,
    ...
    {
        $sql = "DELETE FROM t_d_produit WHERE id_Produit = :id";
        $params = array(
            ':id' => $id
        );
